...
This presentation will walk you through the basic features of showtmux."""
        ...
        self.cmd(
            "# The lines you see me type are pre-recorded, but the commands are actually run, because this sends actual key presses to tmux."
        )
        self.sleep(0.5)
        self.cmd("date")
        self.cmd("uname -a")
...
""",
        ...
        self.cmd(
            "# showtmux can work with other cool terminal apps like mdp and caca-utils"
        )
        self.sleep(0.5)
        ...
        self.wait(
            "We simply inherit from showtmux.Presentation and define the script with present()"
        )
        self.key("M-x")
